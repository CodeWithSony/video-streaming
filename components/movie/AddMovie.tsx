...
export default function AdminPage() {
  ...
  return (
    ...
    <div className=" top-0 netflix-bg h-full w-full bg-[url('https://assets.nflxext.com/ffe/siteui/vlv3/f268d374-734d-474f-ad13-af5ba87ef9fc/web/IN-en-20250210-TRIFECTA-perspective_92338d5d-6ccd-4b1a-8536-eb2b0240a55e_large.jpg')] bg-no-repeat bg-center bg-fixed bg-cover max-w-[100%] min-w-[300px]">
      <div className="bg-black w-full h-full lg:bg-opacity-50 z-0">
        <div className="flex justify-center items-center h-screen w-full">
          <div className="p-4 max-w-lg bg-white [@media(max-width:740px)]:max-w-[400px]">
